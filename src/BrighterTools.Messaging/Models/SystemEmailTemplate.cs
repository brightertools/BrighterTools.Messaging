...
/// <summary>
/// Represents System Email Template.
/// </summary>
public class SystemEmailTemplate : EntityBase
{
    /// <summary>
    ...
    /// </summary>
    public SystemEmailTemplate? BaseTemplate { get; set; }
    /// <summary>
    /// Gets or sets the Sub Templates.
    /// </summary>
    public ICollection<SystemEmailTemplate> SubTemplates { get; set; } = [];
}
